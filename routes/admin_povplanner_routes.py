...
TABLE    = 'pov_planner'
BP_NAME  = 'admin_povplanner'
URL_BASE = '/admin/povplanner'
bp = Blueprint(BP_NAME, __name__)

DEFAULT_COLUMNS = ['Milestone / Step', 'Target Start', 'Target End', 'Owner', 'What It Proves / Notes', 'Status', 'Mandatory']
DEFAULT_KEYS    = ['milestone_step', 'target_start', 'target_end', 'owner', 'what_it_proves', 'status', 'mandatory']
...
def delete_row(row_id):
    try:
        db.session.execute(text("UPDATE question_options SET pov_step_id = NULL WHERE pov_step_id = :id"), {"id": row_id})
